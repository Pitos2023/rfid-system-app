...
export default function AssistantPrincipalNav() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Header */}
      <header className="bg-[#58181F] text-white px-8 py-4 shadow-md">
        <h1 className="text-2xl font-bold">My.SPC</h1>
      </header>

      <h2 className="text-2xl font-semibold text-gray-800 mb-8 mt-6 px-8">
        Assistant Principal Dashboard
      </h2>

      {/* Stats */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <StatsCard title="Total Students" value="1,247" icon="👥" color="purple" />
        <StatsCard title="Notifications Sent" value={notificationsSent} icon="📢" color="blue" />
        <StatsCard title="Active Parents" value="1,089" icon="👨‍👩‍👧‍👦" color="green" />
        <StatsCard title="Security Guards" value="6" icon="🛡️" color="orange" />
      </div>
      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <Link href="/assistant/announcements">
            ...
            >
              <div>
                <h3 className="text-xl font-bold text-[#58181F] mb-2 flex items-center">
